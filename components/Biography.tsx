...
import { getConsecutiveDays, getTrainingHours, getMilesCovered, PROJECTED_VALUES } from "../utils/dateCalculations";
...
const bioText = [
  ...
  `My commitment to my goal is unwavering, with an impressive track record of ${getConsecutiveDays()} consecutive days and ${getTrainingHours()} hours of dedicated training. By the start of the 2028 Olympics, I project to achieve ${PROJECTED_VALUES.hours} hours of training, complete ${PROJECTED_VALUES.workouts} workouts, and maintain a streak of ${PROJECTED_VALUES.days} consecutive days. This dedication has resulted in a total distance of ${getMilesCovered()} miles covered through cycling and running, demonstrating my relentless pursuit of excellence and the depth of my commitment to Olympic qualification.`,
